...
Please don't forget to change the session secret in
config/initializers/secret_token.rb!  If you don't do this, you
are leaving yourself wide open to be hacked.
